...
**You can also read this README in [English](https://github.com/klekwedge/message-form/blob/main/README.EN.md).**
...
1. Сделайте клон этого репозитория ```git clone https://github.com/klekwedge/message-form.git```
...
- [Ссылка на проект](https://github.com/klekwedge/message-form)
- [Деплой](https://klekwedge-message-form.vercel.app/)
